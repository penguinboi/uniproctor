    ...
    $scope.register = function (room) {
    	...
    	if (!room)
    		ServiceParticipant.showError($window, LxNotificationService, {
    			error: {
    				message:"Username, user type and room fields are both required"
    			}
    		});
    	
        $scope.userName = room.userName;
        $scope.roomName = room.roomName;
        $scope.userType = room.userType;
        console.log('room.userType: '+$scope.userType);
        ...
        ServiceRoom.setUserType($scope.userType);
