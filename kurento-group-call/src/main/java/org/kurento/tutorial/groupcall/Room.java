...
public class Room implements Closeable {
  ...
  public UserSession join(String userName, String type, WebSocketSession session) throws IOException {
    log.info("ROOM {}: adding participant of type: {} named {}", userName, type, userName);
    final UserSession participant = new UserSession(userName, type, this.name, session, this.pipeline);
